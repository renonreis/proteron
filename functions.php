...
function wp_bootstrap_4_scripts() {
	...
	// FancyBox CSS
	wp_enqueue_style( 'fancyBox', get_template_directory_uri(). '/assets/fancybox-2.1.7/source/jquery.fancybox.css', array(), '2.1.7', 'all' );

	// Optionally add helpers - button, thumbnail and/or media CSS
	wp_enqueue_style( 'buttons-fancyBox', get_template_directory_uri(). '/assets/fancybox-2.1.7/source/helpers/jquery.fancybox-buttons.css', array(), '1.0.5', 'all' );
	wp_enqueue_style( 'thumbs', get_template_directory_uri(). '/assets/fancybox-2.1.7/source/helpers/jquery.fancybox-thumbs.css', array(), '1.0.7', 'all' );

	//============ JS =======================

	// mousewheel plugin (this is optional)
	wp_enqueue_script( 'mousewheel', get_template_directory_uri() . '/assets/fancybox-2.1.7/lib/jquery.mousewheel.pack.js', array('jquery'), '3.0.6', true );

	// FancyBox JS
	wp_enqueue_script( 'fancybox-js', get_template_directory_uri() . '/assets/fancybox-2.1.7/source/jquery.fancybox.pack.js', array('jquery'), '2.1.7', true );

	// Optionally add helpers - button, thumbnail and/or media CSS
	wp_enqueue_script( 'buttons-js', get_template_directory_uri() . '/assets/fancybox-2.1.7/source/helpers/jquery.fancybox-buttons.js', array('jquery'), '1.0.5', true );
	wp_enqueue_script( 'media', get_template_directory_uri() . '/assets/fancybox-2.1.7/source/helpers/jquery.fancybox-media.js', array('jquery'), '1.0.6', true );
	wp_enqueue_script( 'thumbs-js', get_template_directory_uri() . '/assets/fancybox-2.1.7/source/helpers/jquery.fancybox-thumbs.js', array('jquery'), '1.0.7', true );
